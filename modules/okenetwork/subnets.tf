...
resource "oci_core_subnet" "cp" {
  ...
  security_list_ids          = concat([oci_core_security_list.control_plane_seclist.id], var.security_list_ids["cp"])
...
resource "oci_core_subnet" "workers" {
  ...
  security_list_ids          = concat([oci_core_security_list.workers_seclist.id], var.security_list_ids["workers"])
  vcn_id                     = var.oke_network_vcn.vcn_id
}
...
resource "oci_core_subnet" "int_lb" {
  ...
  security_list_ids          = concat([oci_core_security_list.int_lb_seclist[0].id], var.security_list_ids["int_lb"])
  vcn_id                     = var.oke_network_vcn.vcn_id
...
resource "oci_core_subnet" "pub_lb" {
  ...
  security_list_ids          = concat([oci_core_security_list.pub_lb_seclist[0].id], var.security_list_ids["pub_lb"])
  vcn_id                     = var.oke_network_vcn.vcn_id
